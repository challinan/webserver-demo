...
extern int ToggleLEDHandler(webs_t wp, char_t *urlPrefix, char_t *webDir,
	int arg, char_t *url, char_t *path, char_t *query);
	
extern int ErrorInHandler(webs_t wp, char_t *urlPrefix, char_t *webDir,
	int arg, char_t *url, char_t *path, char_t *query);
 ...
 */
	...
	websUrlHandlerDefine(T("/ToggleLED"), NULL, 0, ToggleLEDHandler, 0); //jnl
	websUrlHandlerDefine(T("/Error"), NULL, 0, ErrorInHandler, 0); //jnl
...
{
	char_t	pname1[25], *pname2;
	static int tempnamid = 0;
